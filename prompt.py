"""Prompt de extracción de facturas para el modelo de OpenAI.

Instruye al modelo para transformar el texto crudo de una factura en un CSV
(`;` como separador) con los campos: fecha_factura, proveedor, concepto, importe, moneda.
Devuelve la palabra 'error' si no puede extraer datos.
"""
...
5️⃣ moneda: Determina la moneda de la factura:
   ...
   - Si contiene "PEN" o "S/" o cualquier otro indicador de que la moneda son soles, devuelve "soles".
